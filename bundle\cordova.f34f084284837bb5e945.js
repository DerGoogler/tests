...
if (window["__os__"] != undefined) {
  (function () {
    ...
    if ( true && typeof require === "function") {
        ...
        module.exports = {
          exec: function (bridgeSecret, service, action, callbackId, argsJson) {
            return prompt(
              argsJson,
              "gap:" +
                JSON.stringify([bridgeSecret, service, action, callbackId])
            );
          },
      ...
      function buildPayload(payload, message) {
        ...
        if (payloadKind === "s") {
          ...
          while (multipartMessages !== "") {
            ...
            var multipartMessage = multipartMessages.substr(
              spaceIdx + 1,
              msgLen
            );
...
/******/ 	var __webpack_exports__ = __webpack_require__("./web/cordova/cordova.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=cordova.f34f084284837bb5e945.js.map